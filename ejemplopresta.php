...
// use PrestaShop\Core\Addon\Module\ModuleManagerBuilder;
...
class ejemplopresta extends Module
{
    ...
    public function install()
    {
        ...
        return parent::install() && $this->getService('ejemplopresta.ps_accounts_installer')->install();;
    }
    ...
    public function getContent()
    {
        ...
        if (((bool)Tools::isSubmit('submitejemploprestaModule')) == true) {
            $this->postProcess();
        }
        ...
        try {
            $accountsFacade = $this->getService('ejemplopresta.ps_accounts_facade');
            $accountsService = $accountsFacade->getPsAccountsService();
        } catch (\PrestaShop\PsAccountsInstaller\Installer\Exception\InstallerException $e) {
            $accountsInstaller = $this->getService('ejemplopresta.ps_accounts_installer');
        ...
        $billingFacade = $this->getService('ejemplopresta.ps_billings_facade');   
